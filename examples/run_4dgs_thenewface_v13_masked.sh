#!/usr/bin/env bash
# Run 4DGS on thenewface — 300 frames, v13 config + masks
#
# Changes from v12:
#   opacity_reg:        0.001  -> 0.005   (stronger floater pruning, removes haze)
#   scale_reg:          0.01   -> 0.05    (penalize large Gaussians)
#   max_num_gaussians:  1.5M   -> 2M      (more densification budget)
#   refine-stop-iter:   30000  -> 40000   (densify longer, 80% of max_steps)
#
set -e
...
RESULT_DIR=/data/shared/elaheh/4D_demo/thenewface_4dgs_f300_v13_masked
