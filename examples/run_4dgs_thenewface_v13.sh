#!/usr/bin/env bash
# Run 4DGS on thenewface — 300 frames, v13 config (no masks)
#
# Same as v13_masked but without --mask_dir
#
set -e

DATA_DIR=/data/shared/elaheh/4D_demo/new_data/thenewface/undistorted
RESULT_DIR=/data/shared/elaheh/4D_demo/thenewface_4dgs_f300_v13
