#!/usr/bin/env bash
# Run 4DGS trainer on elly dataset — 30 frames, v5 + masks: tanh-bounded deformation + grad clipping
set -e

DATA_DIR=/data/shared/elaheh/4D_demo/outdoor/elly/undistorted
RESULT_DIR=/data/shared/elaheh/4D_demo/elly_4dgs_f30_v5_masked
