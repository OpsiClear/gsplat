#!/usr/bin/env bash
# Run 4DGS trainer on elly dataset — 90 frames, full dynamic capture + masks
# Frames: 0, 5, 10, ..., 445 (every 5th frame, 90 total)

set -e

DATA_DIR=/data/shared/elaheh/4D_demo/outdoor/elly/undistorted
RESULT_DIR=/data/shared/elaheh/4D_demo/elly_4dgs_f90_masked
