#!/usr/bin/env bash
# Run 4DGS on roasted_beef — 300 frames, v7 config, no mask
set -e

DATA_DIR=/data/shared/elaheh/4D_demo/roasted_beef/undistorted
RESULT_DIR=/data/shared/elaheh/4D_demo/roasted_beef_4dgs_f300_v7
