#!/usr/bin/env bash
# Run 4DGS on mike_tech — 150 frames, v13 config (no mask)
# v13: centered time [-0.5, 0.5] + progressive frame sampling
...
RESULT_DIR=/data/shared/elaheh/4D_demo/mike_4dgs_f150_v13
