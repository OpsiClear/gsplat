#!/usr/bin/env bash
# Run 4DGS on thenewface — 100 frames (stride 1 from 0), v9 config + masks
# Based on v9 with:
#   - mask_dir for binary masks (white=object, black=background)
#   - frames 0-100, stride 1
#   - random_bkgd off (default now)
set -e
...
RESULT_DIR=/data/shared/elaheh/4D_demo/thenewface_4dgs_f100_v9_masked
