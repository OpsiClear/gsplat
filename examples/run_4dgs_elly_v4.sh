#!/usr/bin/env bash
# Run 4DGS trainer on elly dataset — 30 frames, full dynamic capture v4
# All dynamic improvements: opacity/SH deform, 1st-order smoothness, 8 PE bands, densify through fine phase

set -e

DATA_DIR=/data/shared/elaheh/4D_demo/outdoor/elly/undistorted
RESULT_DIR=/data/shared/elaheh/4D_demo/elly_4dgs_f30_v4
