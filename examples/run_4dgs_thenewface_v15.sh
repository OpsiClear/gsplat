#!/usr/bin/env bash
# Run 4DGS on thenewface — 300 frames, v15 config + masks
#
# Changes from v12:
#   sh_degree:          3    -> 2     (fewer SH bands)
#   data_factor:        4    -> 1     (full resolution)
#   max_num_gaussians:  1.5M -> 5M    (higher capacity)
#   max_steps:          50k  -> 80k   (longer training)
#   refine-stop-iter:   30k  -> 64k   (densify till 80% of max_steps)
#
...
RESULT_DIR=/data/shared/elaheh/4D_demo/thenewface_4dgs_f300_v15_masked
