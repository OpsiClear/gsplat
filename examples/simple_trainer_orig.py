...
try:
    ...
    from gsplat.compression_simulation import simulation, CompressionSimulation
    ...
    EntropyCodingCompression = HevcCompression = CompressionSimulation = None
    Entropy_factorized_optimized_refactor = Entropy_gaussian = None
    class PngCompression: pass

try:
    from lib_bilagrid import BilateralGrid, slice, color_correct, total_variation_loss
except ImportError:
    BilateralGrid = slice = color_correct = total_variation_loss = None
