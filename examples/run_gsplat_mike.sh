...
BASE_DIR="/data/shared/elaheh/4D_demo/mike_tech/undistorted/"

# Directory containing the sequence of PLY files for initialization.
BASE_PLY_DIR="/data/shared/elaheh/4Ddemo_gifstream_results/mike_tech/merged_ply_sequence_FINAL/"

# Define the frame range to be processed.
START_FRAME=39
END_FRAME=239 # Adjust as needed
...
QUATS_LR=1e-3
SH0_LR=2.5e-3
SHN_LR=1.25e-3 # This is 2.5e-3 / 20
...
STATIC_ARGS=(
    ...
    "--disable_viewer"
    "--save_steps" "7000"   "20000"  "30000"
    "--ply_steps"  "7000"   "20000"  "30000"
    "--eval_steps" "7000"  "20000"  "30000"
    "--test_every" "0"
    "--data_factor" "1"
    "--random_bkgd"
    "--strategy.no-verbose"
