#!/usr/bin/env bash
# Run 4DGS on elly — 150 frames, v11 config + masks
# v11: based on v9 but with opacity deform DISABLED (fix for opacity collapse)
#   - depth 0 (no backbone), time_pe_bands 4
...
RESULT_DIR=/data/shared/elaheh/4D_demo/elly_4dgs_f150_v11_masked
