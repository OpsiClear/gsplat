#!/usr/bin/env bash
# Run 4DGS on mike_tech — 64 frames, v12 config + masks
...
MASK_DIR=/data/shared/elaheh/4D_demo/completed_indoor/mike_tech/undistorted/masks
RESULT_DIR=/data/shared/elaheh/4D_demo/mike_tech_4dgs_f64_v12_masked
