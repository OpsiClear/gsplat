#!/usr/bin/env bash
# Run 4DGS on elly — 150 frames, v13 config + masks
# v13: EXPERIMENTAL — centered time [-0.5, 0.5] + progressive frame sampling
#   - keyframe at mid-sequence (t=0), expands ±10% → full over 10k iters
#   - no opacity deform, opacity_reg 0.001
#   - depth 0, time_pe_bands 4 (same base as v11)
set -e
...
RESULT_DIR=/data/shared/elaheh/4D_demo/elly_4dgs_f150_v13_masked
