#!/usr/bin/env bash
# Run 4DGS on thenewface — 300 frames, v11 config + masks
# v11: based on v9 but with opacity deform DISABLED (fix for opacity collapse + OOM)
#   - depth 0 (no backbone), time_pe_bands 4
#   - opacity_reg 0.01 to keep opacities healthy
#   - NO enable_opacity_deform
set -e
...
RESULT_DIR=/data/shared/elaheh/4D_demo/thenewface_4dgs_f300_v11_masked
