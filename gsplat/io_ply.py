#This code is a modified version of the original code, which is available at https://github.com/nerfstudio-project/gsplat
# The modifications are: added support for loading/importing ply files.
