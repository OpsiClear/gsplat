#!/usr/bin/env bash
# Run 4DGS trainer on elly dataset with masks (loss only on object pixels)
# Masks: white=keep, black=ignore

set -e

DATA_DIR=/data/shared/elaheh/4D_demo/outdoor/elly/undistorted
RESULT_DIR=/data/shared/elaheh/4D_demo/elly_4dgs_f30_masked_v3
