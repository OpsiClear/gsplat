...
if __name__ == "__main__":
    ...
    input_ply_file = "/data/shared/elaheh/4D/4D_scenes/elly/gsplat-frame001-distorted_not_normalized/ply/point_cloud_29999.ply"
    
    # Define the FULL path for the output file
    output_file_path = "/data/shared/elaheh/4D/4D_scenes/elly/gsplat-frame001-distorted_not_normalized/bin/points3D.bin"
